...
tireID         = 78;    // Internal diameter (ID) -- How wide is the inside opening? 
...
knobSize          = [90,1.0,1];   // The size of each knob [across wheel, along the perimeter, prodruding]
...
spokeStyle        = "fill";   // none, biohazard, circle, circlefit, diamond, line, rectangle, spiral, fill
...
setScrewNutThickness = 2.8;        // The thickness of the captive nut
